  ...
  <body>
                ...
                <main class="wraper d-flex flex-column align-item-center justify-content-center ">
                    ...
                    <form action="{{ route('create') }}" method="POST" class="todos-form d-flex align-items-center justify-items-center flex-wrap shadow-sm">
                        ...
                        <input type="text" value="{{ $todo->todo }}" name="todo" class="@error('todo') border border-danger @enderror form-control rounded-0"placeholder="enter">
                        <button class="btn btn-primary d-flex align-item-center justify-content-center text-capital">Zapisz</button>
